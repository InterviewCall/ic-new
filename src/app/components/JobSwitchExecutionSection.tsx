...
function FeatureCard() {
    return (
        <div className=" flex justify-center gap-x-5 p-6">
            <div className="mt-2"><Rocket /></div>
            <div className="leading-tight">
                <div className="text-2xl font-light mb-2">
                    Referral workflow
                </div>
                <div className="text-xl text-white/60 font-extralight">3 Jobs of interest</div>
                <div className="text-xl text-white/60 font-extralight">7 High fit targets</div>
            </div>
        </div>
    )
};
